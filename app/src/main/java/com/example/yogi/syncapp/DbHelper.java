...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "create table "+DbContract.TABLE_NAME+"(id integer primary key autoincrement,"+DbContract.NAME
            +" name,"+DbContract.SYNC_STATUS+" integer);";
